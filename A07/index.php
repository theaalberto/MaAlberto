    ...
    <div class="container-fluid my-5">
                ...
                <tbody>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if (isset($_POST["submit"])) {
                            ...
                            $updateSql = "UPDATE gcmembers SET userID = ?, gcID = ? WHERE gcMemberID = ?";
                            $stmt = $conn->prepare($updateSql);
                            $stmt->bind_param("sss", $userID, $gcID, $gcMemberID);
        ...
        <div class="card mb-5">
            <div class="card-header bg-primary text-white">
                <h2 class="h5 mb-0">Add, Delete, or Edit Group Member</h2>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="d-flex flex-column flex-sm-row">
                        ...
                        <button type="submit" name="edit" class="btn btn-warning w-100 w-sm-50 mt-3 mt-sm-0">Edit Member</button>
                    </div>
                </form>
            </div>
        </div>
